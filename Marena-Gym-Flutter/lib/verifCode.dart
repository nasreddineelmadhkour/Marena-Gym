...
import 'package:projetfe/newPassword.dart';
...
class VerifCode extends StatefulWidget {
  ...
  _VerifCode createState() => _VerifCode();
}

// Créer une classe pour l'état de l'écran de login
class _VerifCode extends State<VerifCode> {
  ...
  Future<void> _resetPassword() async {
    ...
    if (email.isNotEmpty) {
      ...
      if(await userViewModel.VerifyCode(_emailController.text))
      {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Code verifier'),
