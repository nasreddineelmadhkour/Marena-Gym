...
import 'package:projetfe/verifCode.dart';
...
class _ForgetPasswordState extends State<ForgetPassword> {
  ...
  Future<void> _resetPassword() async {
    ...
    if (email.isNotEmpty && email.contains('@')) {
      ...
      if(await userViewModel.SendCodeReset(_emailController.text))
        {
          StaticUser.staticUser.email=_emailController.text;
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          Navigator.push(context, MaterialPageRoute(builder: (context) => VerifCode()));
        }
      else{
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
